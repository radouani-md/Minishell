...
SRC = parsing/implement_unset.c parsing/minishell.c parsing/implement_export.c parsing/ft_function_free.c parsing/ft_read_and_filling_node.c parsing/ft_1read_and_filling_node.c parsing/ft_syntax_erorr.c parsing/ft_typed_nodes.c parsing/ft_claiming_env.c \
