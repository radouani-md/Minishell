CC = cc
CFLAGS = -Wall -fsanitize=address -g #-Wextra -Werror -fsanitize=address -g
NAME = minishell 
HEADER = minishell.h 
READ_LINE = -lreadline

SRC = parsing/cc.c parsing/gc_malloc.c parsing/implement_unset.c parsing/minishell.c parsing/implement_export.c parsing/ft_read_and_filling_node.c parsing/ft_syntax_erorr.c parsing/ft_typed_nodes.c parsing/ft_claiming_env.c \
